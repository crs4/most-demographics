...
urlpatterns += patterns('',
    ...
    (r'^patient/edit/$', patient.edit),
    (r'^patient/deactivate/$', patient.deactivate),
    (r'^patient/activate/$', patient.activate),
    (r'^patient/add_id/$', patient.add_identifier),
    (r'^patient/remove_id/$', patient.remove_identifier),
    (r'^patient/set_birth_place/$', patient.set_birth_place),
    (r'^patient/set_city/$', patient.set_city),
...
urlpatterns += patterns('',
    ...
    (r'^identifier/edit/$', identifier.edit),
    (r'^identifier/get_patient/$', identifier.get_patient),
)
